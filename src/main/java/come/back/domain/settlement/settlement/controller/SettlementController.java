...
public class SettlementController {
    ...
    public ResultData<String> getSettlementTransaction(@PathVariable Long roomId, @PathVariable Long transactionId) {
        // TODO: 정산 거래 상세 조회 서비스 연결 (roomId-transactionId 정합성 검증 포함) [NENA-12]
    ...
    public ResultData<String> completeSettlementTransaction(
            @PathVariable Long roomId, @PathVariable Long transactionId) {
